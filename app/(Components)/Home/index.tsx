...
const Home = () => {
  ...
  return (
    <div className=' flex min-[1000px]:flex-row flex-col md:gap-4 gap-6 w-full' id='info'>
          ...
          <div className='space-y-4'>
            ...
            <div className='  flex items-center'>
              ...
              <div className='relative'>
                <div className='ext-2xl md:text-3xl bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent animate-slide-up key-{currentRole}'>
