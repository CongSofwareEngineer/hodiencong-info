...
const ItemMenu = ({ link, title }: Item) => {
  return (
    <Link
      className='relative px-4 py-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 group'
      href={link}
    >
...
const Nav = () => {
  ...
  return (
    <nav className='items-center flex min-[850px]:flex-row flex-col gap-8'>
