      ...
      <div className='w-full max-w-[1550px] px-5 m-auto flex items-center gap-3 h-full '>
        ...
        <div className='flex flex-1 justify-between items-center'>
          ...
          <div className='flex md:pl-8 pl-3 md:gap-8 gap-3 items-center border-l border-gray-200 dark:border-gray-700'>
            <MyButton
              className='relative h-10 md:min-w-10 min-w-max border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-blue-500 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 rounded-xl group p-0 flex items-center justify-center'
              color='outline'
